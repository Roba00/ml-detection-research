...
from src.losses.ssd_loss import eval_forward

# Requirements for Model
# ----------------------------------------------------------------------------------------------------------------------
# URL: https://pytorch.org/vision/main/models/generated/torchvision.models.detection.ssd300_vgg16.html
...
class SSD:
    ...
    def save_model(
        self,
        model_path: str = "/content/drive/My Drive/weights/ssd/",
    ):
    ...
    def load_model(
        self,
        model_path: str = "/content/drive/My Drive/weights/ssd/rename_weight.pt",
    ):
