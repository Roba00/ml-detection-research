...
from src.losses.faster_rcnn_loss import eval_forward

# Requirements for Model
# ----------------------------------------------------------------------------------------------------------------------
# URL: https://pytorch.org/vision/main/models/generated/torchvision.models.detection.fasterrcnn_resnet50_fpn.html
...
# Hyperparameter: Use IoU of 0.2, bounding box of size 20*20, and nms 0.2, lower learning rate 1e-3, batch size 16
# Evaluation IoU:
class Faster_RCNN:
    ...
    def test_one_epoch(
        ...
        def evaluate_loss(
            ...
            for i in range(len(images)):
                ...
                targets.append(d)
            losses = eval_forward(self.model, images, targets)[0]
            return losses
